...
namespace Phpkg\BusinessSpecifications\Project;
...
use Phpkg\InfrastructureStructure\Exception\ArchiveDownloadException;
use Phpkg\InfrastructureStructure\Envs;
use function PhpRepos\Observer\Observer\broadcast;
use function Phpkg\SoftwareSolutions\Parser\Parsers\find_starting_point_for_imports;
use function Phpkg\SoftwareSolutions\Parser\Parsers\get_registry;
use function Phpkg\InfrastructureStructure\Arrays\first;
use function Phpkg\InfrastructureStructure\Arrays\map;
use function Phpkg\InfrastructureStructure\Arrays\reduce;
...
function run(string $url_or_path, ?string $version, ?string $entry_point): Outcome
{
    ...
    if ($entry_point && !\Phpkg\InfrastructureStructure\Files\file_exists($entry_point)) {
